...
function LoadCreateEvent()
{
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            const tmpPlaces = []
            const response = await fetch('http://'+process.env.REACT_APP_BASE_URL+'/places/ownerplaces?id='+id)
    ...
    const createEvent=async()=>{
      ...
      const res = await axios.post('http://'+process.env.REACT_APP_BASE_URL+'/events/create',data,
          {
              headers: {
